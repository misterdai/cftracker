...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
	...
	<cffunction name="getRootLogger" access="public" returntype="logbox.system.logging.Logger" output="false" hint="Get the root logger">
	...
	<cffunction name="setRootLogger" access="public" returntype="void" output="false" hint="Set the root logger for this named logger.">
		<cfargument name="RootLogger" type="logbox.system.logging.Logger" required="true">
...
<!------------------------------------------- APPENDER METHODS ------------------------------------------->
	...
	<cffunction name="addAppender" output="false" access="public" returntype="void" hint="Add a new appender to the list of appenders for this logger. If the appender already exists, then it will not be added.">
		<cfargument name="newAppender" type="logbox.system.logging.AbstractAppender" required="true" default="" hint="The new appender to add to this logger programmatically."/>
		<cfscript>
			var name= "";
