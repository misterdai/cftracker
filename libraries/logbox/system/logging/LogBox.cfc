...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
	...
	<cffunction name="getConfig" access="public" returntype="logbox.system.logging.config.LogBoxConfig" output="false" hint="Get this LogBox's configuration object.">
...
<!------------------------------------------- PUBLIC ------------------------------------------->
	...
	<!--- getRootLogger --->
	<cffunction name="getRootLogger" output="false" access="public" returntype="logbox.system.logging.Logger" hint="Get the root logger">
		<cfreturn instance.loggerRegistry["ROOT"]>
	</cffunction>

	<!--- getLogger --->
	<cffunction name="getLogger" output="false" access="public" returntype="logbox.system.logging.Logger" hint="Get a logger object configured with a category name and appenders. If not configured, then it reverts to the root logger defined for this instance of LogBox">
